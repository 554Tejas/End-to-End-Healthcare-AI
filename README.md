...
|---|---|---|
| Tejas Soni | 22052169 | ADR classifier (TF-IDF + Logistic Regression), NER integration |
| Sanskriti Agarwal | 2205846 | Medicine recommendation system |
| Souramay Bhowmik | 22052160 | Full-stack integration (FastAPI backend + Next.js frontend) |
| Sumit Kumar Mandal | 22052166 | BERT fine-tuning for disease prediction |
| Rajdeep Ganguly | 22053337 | EDA, data preprocessing, feature engineering |
| Soumya Dhankar | 22051465 | Dataset curation, documentation |
